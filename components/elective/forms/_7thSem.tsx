...
const ElectiveForm_7thSem = (props: Props) => {
  ...
  const [elective_7_option_5, setElective7Option5] = useState<string>("");
      ...
      case elective_7:
        switch (option_number) {
          ...
          case 4:
            ...
            break;
          case 5:
            setElective7Option5(event.target.value);
            break;
        }
        break;
      case elective_8:
  ...
  const handleSubmit = async () => {
    ...
    const elective_selections = {
      ELECTIVE_7: {
        ...
        ...(props.ELECTIVE_7_OPTIONS.length >= 5 && {
          OPTION_5: selected_subject_transformer(elective_7_option_5),
        }),
      },
      ELECTIVE_8: {
            ...
            <StepContent>
                    ...
                    return (
                      <MenuItem
                        ...
                        disabled={
                          ...
                          elective_7_option_5 === subjectName
                        }
                      >
                        {subjectName}
                      </MenuItem>
              ...
              {props.ELECTIVE_7_OPTIONS.length > 4 && (
                <FormControl sx={{ m: 1, minWidth: 200 }}>
                  ...
                  <Select
                    value={elective_7_option_5}
                    onChange={(e: SelectChangeEvent) =>
                      handleChange(elective_7, 5, e)
                    }
                    displayEmpty
                    inputProps={{ "aria-label": "Without label" }}
                    label="OPTION 5"
