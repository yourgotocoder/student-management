...
const allotment = (seats: Seats, data: Student[]) => {
  const _4thSemSelectionData = [...data]
    .filter(
      (student) =>
        student.CGPA && student.ELECTIVE_SELECTIONS && student.CURRENT_SEM === 4
    )
    .sort((a, b) => {
    ...
    .map((student) => ({
      ...
      NAME: student.NAME,
      CGPA: student.CGPA,
      ELECTIVE_SELECTION: student.ELECTIVE_SELECTIONS?.ELECTIVE_2,
    }));
  ...
  const _4thSemSeats: any = {
    "Fundamentals of Web Technology": seats._4thSemSeats,
    "Python Programming": seats._4thSemSeats,
    "Java Programming": seats._4thSemSeats,
    "User Interface/User Experience (UI/UX) Design": seats._4thSemSeats,
  };
